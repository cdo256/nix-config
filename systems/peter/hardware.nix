...
in
{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/3384b944-6552-402c-8458-b195580aa428";
    fsType = "ext4";
  };

  fileSystems."/bak" = {
    device = "/dev/disk/by-uuid/db250592-fef3-4b4d-a1e2-3d31167a0037";
    fsType = "ext4";
  };
  ...
  hardware.cpu.amd.updateMicrocode = kDefault config.hardware.enableRedistributableFirmware;
}
